...
#define FRAMETIME 20	//this is used for animations, it basically changes animation every .20 of a second
...
#define NUMBER_OF_ENEMIES 4 //number of total object spaces the game allocates for enemies
...
#define NUMBEROFNODES 320/NUMBER_OF_ENEMIES
#define XBATTLESTART 16 //default battle position for th eplayer
